...
class SettingAdapter : RecyclerView.Adapter<SettingAdapter.ViewHolder>(){
    ...
    fun addDevice(deviceDetail: BluetoothDeviceWrapper?) {
        if (deviceDetail == null) {
            ...
            if (null != deviceDetail.feasyBeacon) {
                if (("21" == deviceDetail.feasyBeacon.module || "25" == deviceDetail.feasyBeacon.module || "26" == deviceDetail.feasyBeacon.module || "27" == deviceDetail.feasyBeacon.module || "28" == deviceDetail.feasyBeacon.module || "29" == deviceDetail.feasyBeacon.module || "30" == deviceDetail.feasyBeacon.module || "34" == deviceDetail.feasyBeacon.module || "35" == deviceDetail.feasyBeacon.module || "31" == deviceDetail.feasyBeacon.module || "36" == deviceDetail.feasyBeacon.module || "39" == deviceDetail.feasyBeacon.module)
