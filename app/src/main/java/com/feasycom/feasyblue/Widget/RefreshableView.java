...
import com.feasycom.feasyblue.Activity.SearchDeviceActivity;
...
public class RefreshableView extends LinearLayout implements View.OnTouchListener {
    ...
    private FscSppApi sppWrapper= FscSppApiImp.getInstance();
        ...
        if (firstChild != null) {
            ...
            if (firstVisiblePos == 0 && firstChild.getTop() == 0) {
                ...
                if (headerLayoutParams.topMargin != hideHeaderHeight) {
                    headerLayoutParams.topMargin = hideHeaderHeight;
//                    header_text_check.setLayoutParams(headerLayoutParams);
                }
                ableToPull = false;
            }
        } else {
...
//        if(null!=SearchDeviceActivity.adapter){
//            SearchDeviceActivity.adapter.notifyDataSetChanged();
//        }
